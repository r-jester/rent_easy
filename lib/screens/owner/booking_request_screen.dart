                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Move-in: ${booking.moveInDate == null ? 'Not set' : AppDateUtils.pretty(booking.moveInDate!)}'),
                                  Text('Lease: ${booking.leaseMonths} months'),
                                  Text('Rent: ${booking.monthlyRent.toUsd()}/month'),
